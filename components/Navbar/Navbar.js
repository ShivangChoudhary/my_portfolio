        ...
        <div className='fixed w-full shadow-xl h-20 z-[100]'>
            <div className='flex justify-between items-center w-full h-full px-2 2xl:px-16'>
                <div>
                    <ul>
                        <Link href='/'>
                            <li className='ml-10 font-extrabold text-1xl  uppercase text-sm font-mono border-b  bg-clip-text bg-gradient-to-r from-purple-400 to-pink-600'>Shivang Choudhary</li>
                        </Link>
                    ...
                    <div className='py-4 flex flex-col'>
                        ...
                        <div className='pt-40'>
                            ...
                            <div className='flex items-center justify-between my-5 w-full sm:w-[80%]'>
                                ...
                                <Link href='https://www.geeksforgeeks.org/user/shivang_choudhary/'
                                    target='_blank'
                                    rel='noreferrer'
                                >
                                    <div
                                ...
                                <Link href='/#contact'>
                                    <div
                                        onClick={() => {
                                            setNav(!nav)
                                            window.location.href = 'mailto:shivang.ch007@gmail.com'
                                        }}
                                        className='rounded-full shadow-lg shadow-gray-400 p-3 cursor-pointer hover:scale-105 ease-in duration-300'
                                    >
                                        <AiOutlineMail />
