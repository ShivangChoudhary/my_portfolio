                ...
                <motion.div initial={{ opacity: 0 }}
                    whileInView={{ y: [-50, 0], opacity: 1 }} className='grid grid-cols-2 lg:grid-cols-4 gap-8'>
                        ...
                        <div className='grid grid-cols-2 gap-4 justify-center items-center'>
                            ...
                            <div className='m-auto'>
                                <Image src={'https://www.svgrepo.com/show/452234/java.svg'} width='35' height='35' alt='/' />
                            </div>
                    ...
                    <div className='p-6 shadow-xl rounded-xl hover:scale-105 ease-in duration-300'>
                        <div className='grid grid-cols-2 gap-4 justify-center items-center'>
                            ...
                            <div className='m-auto'>
                                <Image src={'https://www.svgrepo.com/show/353751/flutter.svg'} width='35' height='35' alt='/' />
                            </div>
                    ...
                    <div className='p-6 shadow-xl rounded-xl hover:scale-105 ease-in duration-300'>
                        <div className='grid grid-cols-2 gap-4 justify-center items-center'>
                            ...
                            <div className='m-auto'>
                                <Image src={'https://www.svgrepo.com/show/473761/powerbi.svg'} width='35' height='35' alt='/' />
                            </div>
                        </div>
                    </div>
                    ...
                    <div className='p-6 shadow-xl rounded-xl hover:scale-105 ease-in duration-300'>
                        <div className='grid grid-cols-2 gap-4 justify-center items-center'>
                            ...
                            <div className='m-auto'>
                                <Image src={'https://www.svgrepo.com/show/327408/logo-vercel.svg'} width='35' height='35' alt='/' />
                            </div>
                        </div>
                    </div>
                    ...
                    <div className='p-6 shadow-xl rounded-xl hover:scale-105 ease-in duration-300'>
                        <div className='grid grid-cols-2 gap-4 justify-center items-center'>
                            ...
                            <div className='m-auto'>
                                <Image src={'https://www.svgrepo.com/show/353631/dart.svg'} width='25' height='25' alt='/' />
                            </div>
                        </div>
                    </div>
                    <div className='p-6 shadow-xl rounded-xl hover:scale-105 ease-in duration-300'>
